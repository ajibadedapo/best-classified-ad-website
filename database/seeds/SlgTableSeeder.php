...
class SlgTableSeeder extends Seeder
{
    /**
    ...
    /**
     * Seeds the states table
     * @return void
     */
    public function seedStatesTable()
    {
    ...
    /**
     * Seeds the local_govt table
     * @return void
     */
    public function seedLGTable()
    {
      if (Schema::hasTable('local_govt')) {
        DB::insert($this->formatQuery('lg'));
      }
    }

    /**
     * removes new lines from the query string and
     * replaces them with spaces
     * @param  [string] $query - query to be formatted
    ...
    /**
     * fetches raw query for states table
     * @return [string]  - query
     */
    private function getStateQuery()
    {
      return "INSERT INTO states (id, name) VALUES
        (1, 'Abia State'),
        (2, 'Adamawa State'),
        (3, 'Akwa Ibom State'),
        (4, 'Anambra State'),
